...
public class DBAdapter {
    ...
    /************* Database Name ************/
    //public static final String DATABASE_PATH = "D:/sw/Eclipse/jani-eclipse/HRMS_Databasefiles/";
    public static final String DATABASE_NAME = "DB_sqllite.db";
    //public static final String DATABASE_NAME = "HRMSDATABASE.db ";
  ...
  public static void addDBGETSET(DBGETSET uData) {
   ...
   public static int updateUserData(DBGETSET data) {
   ...
   public static DBGETSET getDBGTSET(int id) {
       ...
       // Open database for Read / Write
        ...
        DBGETSET data = new DBGETSET(Integer.parseInt(cursor.getString(0)),
    ...
    public static List<DBGETSET> getAllUserData() {
 
        List<DBGETSET> contactList = new ArrayList<DBGETSET>();
        // Select All Query
    ...
    public static void deleteUserData(DBGETSET data) {
        final SQLiteDatabase db = open();
